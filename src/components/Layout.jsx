...
import { Shield, List, Users, Settings, LogOut, PlusCircle, Car, ScanLine } from 'lucide-react'
        ...
        {nav.map(({ to, icon: Icon, label }) => {
          ...
          return (
            <Link
              key={to}
              to={to}
              className={`flex flex-col items-center gap-0.5 px-3 py-1 rounded-lg transition text-xs font-medium ${
